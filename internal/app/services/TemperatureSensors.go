...
func FetchAllTemperatureSensors(db *sql.DB) []models.TemperatureSensor {
...
func FetchTemperatureSensor(sensorId string, db *sql.DB) models.TemperatureSensor {
...
func FetchGarageTemperatureSensor(db *sql.DB) models.TemperatureSensor {
...
func AddNewTemperatureSensor(sensor *models.TemperatureSensor, db *sql.DB) {
...
func UpdateTemperatureSensor(sensor *models.TemperatureSensor, db *sql.DB) {
